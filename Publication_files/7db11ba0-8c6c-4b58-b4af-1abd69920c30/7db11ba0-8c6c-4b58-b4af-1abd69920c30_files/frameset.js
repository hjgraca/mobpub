...
var DiagramPath = "7db11ba0-8c6c-4b58-b4af-1abd69920c30_files";
var xmlData = XMLData(DiagramPath + "/data.xml");
var iServerXML = XMLData("iserverdiagram.xml");
var iServerData = CreateDocument(iServerXML);
var PublicationPropertiesData = XMLData("../publicationproperties.xml");
var PublicationData = CreatePublicationNotes(PublicationPropertiesData);
